...
## Шаблон задачи (RU)
## Задача 102
* __Название__: Алгоритмы стационарной точки в задаче федеративного децентрализованного обучения (Federated Decentralized Learning). 
* __Задача__: Задача состоит в обобщении теоретических результатов сходимости оптимизационных алгоритмов распределенного и федеративного обучения на децентрализованный случай. В этом режиме данные находятся на разных клиентах и эти клиенты могут передавать информацию по определенному графу, не имея центрального сервера. Задача записывается в виде минимизации конечной суммы $\min _{\mathbf{x} \in \mathbb{R}^d}\left[f(\mathbf{x}):=\frac{1}{n} \sum_{i=1}^n f_i(\mathbf{x})\right]$.
* __Данные__: Краткое описание данных, используемых в вычислительном эксперименте, и ссылка на выборку. 
* __Литература__: Список научных работ, дополненный 1) формулировкой решаемой задачи, 2) ссылками на новые результаты, 3) основной информацией об исследуемой проблеме. 
* __Базовой алгоритм__: Ссылка на алгоритм, с которым проводится сравнение или на ближайшую по теме работу. 
* __Решение__: Предлагаемое решение задачи и способы проведения исследования. Способы представления и визуализации данных и проведения анализа ошибок, анализа качества алгоритма. 
